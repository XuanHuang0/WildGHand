...
def get_uvd(pts, mesh_vertices, mesh_faces, mesh_face_uv):
    ...
    # print(mesh_face_uv[min_face_idx].shape)
    # print(bary_coords.unsqueeze(-1).shape)
    # change_face = np.load("change/change_face.npy")
    # print(min_face_idx.shape)
    # min_face_idx[min_face_idx<mesh_faces.shape[0]/2]=change_face[int(min_face_idx[min_face_idx<mesh_faces.shape[0]/2]-mesh_faces.shape[0]/2)]+int(mesh_faces.shape[0]/2)
    ...
    # signed_dist = signed_dist.unsqueeze(-1)

    return sampled_uvs.unsqueeze(0), signed_dist.unsqueeze(0), intermediates
