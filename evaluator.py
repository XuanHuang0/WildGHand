...
class Evaluator:
    ...
    def _compute_ssim(self, rgb_pred, rgb_gt, input_imgs, mask_at_box, human_idx, frame_index, view_index):
        ...
        # cv2.imwrite(os.path.join(pred_dir, f'frame{frame_index}_view{view_index}_all.png'), (rgb_pred[..., [2, 1, 0]]*255))
        # cv2.imwrite(os.path.join(gt_dir, f'frame{frame_index}_view{view_index}_gt_all.png'), (rgb_gt[..., [2, 1, 0]]*255))
